...
//                "(9, '. Anne: 'Make yourself at home'.         -- John : '._________________.''  ',1,'A.Yes, Can I help you?   ','B.Not at all. Don't mention it.   ','C.Thanks! Same to you.    ','D.That's very kind. Thank you','D'), \n"+
...
//                "(57, 'She is so absent-minde. She _______________ her cell phone three times. ',2,'A.lost ','B.was losing ','C.has lost ','D.had lost','C'), \n"+
...
//                "(68, 'They live on a busy street. _______________ a lot of noise and pollution from traffi ',3,'A.It must be ','B.It must have ','C.There must have ','D.There must be ','D'), \n"+
